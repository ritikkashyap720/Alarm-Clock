...
setAlarm.addEventListener("click", function () {
    ...
    if (aHour.value == "Hour") {
        ...
        if (aMin.value == "Minute") {
            ...
            // if(currentDate.ampm=="PM"){
                if (AAmPm.value == "PM") {
                    if(aHour.value<12){
                        var hour = Number(aHour.value) + 12;
                        console.log("in less than pmpm");
                    }
                    else{
                        console.log("in 12 pmpm");
                        var hour = Number(aHour.value) ;                      
                    }
                }
                else {
                    if(aHour.value<12){
                        console.log("in less than 12 pmam");
                        var hour = Number(aHour.value);
                    }
                    else{
                        console.log("in 12 pmam");
                        var hour = Number(aHour.value)-12;    
                    }
                    // var hour = Number(aHour.value) ;
                }
